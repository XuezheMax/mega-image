...
def create_scheduler(args, optimizer, step_per_epoch=1):
    ...
    elif args.sched == 'cosine_step':
        lr_scheduler = CosineLRScheduler(
            optimizer,
            t_initial=num_epochs*step_per_epoch,
            lr_min=args.min_lr,
            warmup_lr_init=args.warmup_lr,
            warmup_t=args.warmup_epochs*step_per_epoch,
            k_decay=getattr(args, 'lr_k_decay', 1.0),
            t_in_epochs=False,
            **cycle_args,
            **noise_args,
